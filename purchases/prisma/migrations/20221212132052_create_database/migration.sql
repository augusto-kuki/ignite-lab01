...
-- AddForeignKey
ALTER TABLE "Purchase" ADD CONSTRAINT "Purchase_produtcId_fkey" FOREIGN KEY ("produtcId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
